...
class RiskgraphController extends JWTAuthorizedBase {
        ...
        switch (method) {
            ...
            case 'POST':
                switch (id) {
                    ...
                    // Find risk data v1.0
                    case 'call-detectors': this.callDetectors(callback); break
                }
                // first switch
                break;
        }
    ...
    /**
     * @swagger
     *  /riskgraph/call-detectors:
     *    post:
     *      tags:
     *         - FLASK RISKGRAPH
     *      summary: Risk Graph is an API service that takes clinical data and evaluates if the data is anomalous.
